...
dht/temp e dht/hum → valores de temperatura e umidade.
...
O projeto pode ser executado no Wokwi (https://wokwi.com/
) utilizando o arquivo diagram.json e o código disponível no repositório.
...
Crie uma conta gratuita em https://thinger.io
.

Cadastre um novo dispositivo com:

Device ID: esp32_dht22

Device Credential: conforme definido no código.

Crie um dashboard e adicione os widgets descritos acima.

Execute o projeto no Wokwi e aguarde a conexão Wi-Fi para visualizar os dados em tempo real.
...
Repositório GitHub: (adicionar o link do repositório aqui)
